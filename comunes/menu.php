    ...
    <div class="offcanvas offcanvas-end bg-success" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=modelo">MODELO DE PRODUCTOS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=categoria">CATEGORIAS DE PRODUCTOS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=productosaj">PRODUCTOS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=proveedor">PROVEEDORES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=empleados">EMPLEADOS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-lg-2" style="font-weight: 600; font-size: 14;" href="?pagina=cliente">CLIENTES</a>
          </li>
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" style="font-weight: 600; font-size: 14;" href="?pagina=entrada">Notas de Entrada</a>
