...
<!-- <<<<<<< HEAD -->
    <a img src="img/logo.png" alt="" style="width:50px;" class="navbar-brand text-light" href=".">FRUTILARA</a>
<!-- ======= -->
    ...
    <div class="offcanvas offcanvas-end bg-success" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link text-light"  href="?pagina=productosaj">Productos</a>
          </li>
          <li class="nav-item">
