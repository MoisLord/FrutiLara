<html>
<?php require_once("comunes/nuevos/head.php"); ?>
<body>
<div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
                ...
                <ul class="contact-info__list list-style--none position-relative z-index-101">
                    <li class="mb-4 pl-4">
                        <span class="position-absolute"><i class="fas fa-envelope"></i></span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0f7c7a7f7f607d7b4f6d60607b6b6a76216c6062">[email&#160;protected]</a>
                    </li>
                    <li class="mb-4 pl-4">
...
<?php require_once("comunes/nuevos/body.php"); ?>
</body>
</html>