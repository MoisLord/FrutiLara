...
$(document).ready(function () {
  ...
  $("#telefono").on("keyup", function () {
    validarkeyup(
      ...
      $(this),
      $("#stelefono"),
      "El formato debe ser 01012510101"
    );
  });
  ...
  $("#correo").on("keyup", function () {
    validarkeyup(
      /^[A-Za-z0-9_\b\s\u00f1\u00d1\u00E0-\u00FC]{3,30}[@]{1}[A-Za-z0-9]{3,8}[.]{1}[A-Za-z]{2,3}$/,
      $(this),
      $("#scorreo"),
      "El formato debe ser alguien@servidor.com"
    );
  });
...
function validarenvio() {
  if (
    ...
    muestraMensaje(
      "Nombre y apellido <br/>Solo letras  entre 3 y 30 caracteres"
    );
    return false;
  } else if (
    validarkeyup(
      ...
      $("#telefono"),
      $("#stelefono"),
      "El formato debe ser 99999999999"
    ) == 0
  ) {
